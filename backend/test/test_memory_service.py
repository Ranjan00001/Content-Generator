...
mongo_id = MemoryAgent.store_content_in_mongo(
    user_id="user123",
    content_type="blog",
...
MemoryAgent.store_vector_embedding(
    user_id="user123",
...
content = MemoryAgent.query_content_from_mongo(mongo_id)
